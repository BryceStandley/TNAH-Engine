...
cs:MakeGameObject("token", "./res/models/tokens/fbx/Speed_Up.fbx", "./res/shader/modelV.glsl", "./res/shader/modelF.glsl", 0.005, 30, 1, 50, 10);
cs:MakeGameObject("token", "./res/models/tokens/fbx/Double_Damage.fbx", "./res/shader/modelV.glsl", "./res/shader/modelF.glsl", 0.005, 30, 1, 30, 10);
