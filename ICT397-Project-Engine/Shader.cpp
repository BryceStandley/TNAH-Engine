...
Shader::Shader(const char* vertexPath, const char* fragmentPath, const char* geometryPath)
{
    ...
    {
        if(Debugger::GetInstance()->debugToConsole) std::cout << "Shader.cpp::ERROR::SHADER::FILE_NOT_SUCCESFULLY_READ" << std::endl;
    }
...
void Shader::checkCompileErrors(GLuint shader, std::string type)
{
    ...
    if (type != "PROGRAM")
    {
        ...
        if (!success)
        {
            ...
            if(Debugger::GetInstance()->debugToConsole) std::cout << "Shader.cpp::ERROR::SHADER_COMPILATION_ERROR of type: " << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
        }
    }
    else
    {
        ...
        if (!success)
        {
            ...
            if(Debugger::GetInstance()->debugToConsole) std::cout << "Shader.cpp::ERROR::PROGRAM_LINKING_ERROR of type: " << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
        }
    }
}