...
unsigned int \mbox{\hyperlink{class_open_g_l_a3b91f32179a5911bd4282d25ab303e9b}{Texture\+From\+File}} (std\+::string path)
\item 
virtual int \mbox{\hyperlink{class_open_g_l_ae91179c1433c7d8a4237cabc7fa2aa87}{Load\+Model}} (int num\+Frames, std\+::vector$<$ int $>$ commands, unsigned int \&VAO, \mbox{\hyperlink{_renderer_8h_acf5f91efba7d6057c5897630b7ec39fa}{v3}} \mbox{\hyperlink{_md2_8cpp_ac5bea0747461c7a8e51b84f54ae66215}{anorms}}\mbox{[}162\mbox{]}, std\+::vector$<$ std\+::vector$<$ glm\+::vec3 $>$$>$ vertices, std\+::vector$<$ std\+::vector$<$ int $>$$>$ normals)
\item 
virtual void \mbox{\hyperlink{class_open_g_l_abd21c569fe2bbdbc80414e8f2dbdc08c}{Render\+Model}} (int number, \mbox{\hyperlink{struct_md2_state}{Md2\+State}} $\ast$anim\+State, glm\+::mat4 proj, glm\+::mat4 view, glm\+::mat4 gen\+Four, float direction, unsigned int \&VAO, unsigned int \&texture\+Id, \mbox{\hyperlink{class_shader}{Shader}} \&shader)
\item 
virtual void \mbox{\hyperlink{class_open_g_l_a6e739507fe6fb9f98641ac3a22629a0d}{Render\+Model}} (int number, \mbox{\hyperlink{struct_md2_state}{Md2\+State}} $\ast$anim\+State, glm\+::mat4 proj, glm\+::mat4 view, glm\+::vec3 position, glm\+::vec3 rotation, float direction, unsigned int \&VAO, unsigned int \&texture\+Id, \mbox{\hyperlink{class_shader}{Shader}} \&shader)
\item 
\mbox{\hyperlink{class_glfw_window}{Glfw\+Window}} $\ast$ \mbox{\hyperlink{class_open_g_l_a471a096ab21f2552a9a279f25e101e8f}{Get\+Glfw\+Window}} ()
\item 
void \mbox{\hyperlink{class_open_g_l_a313973a3e955e2dfbae3089346a93a03}{Set\+Glfw\+Window}} (\mbox{\hyperlink{class_glfw_window}{Glfw\+Window}} $\ast$g)
...
\index{OpenGL@{OpenGL}!DepthTest@{DepthTest}}
\index{DepthTest@{DepthTest}!OpenGL@{OpenGL}}
\doxysubsubsection{\texorpdfstring{DepthTest()}{DepthTest()}}
{\footnotesize\ttfamily void Open\+GL\+::\+Depth\+Test (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
...
Reimplemented from \mbox{\hyperlink{class_renderer_a02beced87878dd00ad9370c2b524c4ad}{Renderer}}.
...
\index{OpenGL@{OpenGL}!GetGlfwWindow@{GetGlfwWindow}}
\index{GetGlfwWindow@{GetGlfwWindow}!OpenGL@{OpenGL}}
\doxysubsubsection{\texorpdfstring{GetGlfwWindow()}{GetGlfwWindow()}}
{\footnotesize\ttfamily \mbox{\hyperlink{class_glfw_window}{Glfw\+Window}}$\ast$ Open\+GL\+::\+Get\+Glfw\+Window (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}

\mbox{\Hypertarget{class_open_g_l_ae91179c1433c7d8a4237cabc7fa2aa87}\label{class_open_g_l_ae91179c1433c7d8a4237cabc7fa2aa87}} 
\index{OpenGL@{OpenGL}!LoadModel@{LoadModel}}
\index{LoadModel@{LoadModel}!OpenGL@{OpenGL}}
\doxysubsubsection{\texorpdfstring{LoadModel()}{LoadModel()}}
{\footnotesize\ttfamily int Open\+GL\+::\+Load\+Model (\begin{DoxyParamCaption}\item[{int}]{num\+Frames,  }\item[{std\+::vector$<$ int $>$}]{commands,  }\item[{unsigned int \&}]{VAO,  }\item[{\mbox{\hyperlink{_renderer_8h_acf5f91efba7d6057c5897630b7ec39fa}{v3}}}]{anorms\mbox{[}162\mbox{]},  }\item[{std\+::vector$<$ std\+::vector$<$ glm\+::vec3 $>$$>$}]{vertices,  }\item[{std\+::vector$<$ std\+::vector$<$ int $>$$>$}]{normals }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}



Reimplemented from \mbox{\hyperlink{class_renderer_a441f883bb48f39e015d54c83ef805c99}{Renderer}}.
...
{\footnotesize\ttfamily void Open\+GL\+::\+Render\+Model (\begin{DoxyParamCaption}\item[{int}]{number,  }\item[{\mbox{\hyperlink{struct_md2_state}{Md2\+State}} $\ast$}]{anim\+State,  }\item[{glm\+::mat4}]{proj,  }\item[{glm\+::mat4}]{view,  }\item[{glm\+::mat4}]{gen\+Four,  }\item[{float}]{direction,  }\item[{unsigned int \&}]{VAO,  }\item[{unsigned int \&}]{texture\+Id,  }\item[{\mbox{\hyperlink{class_shader}{Shader}} \&}]{shader }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}



Reimplemented from \mbox{\hyperlink{class_renderer_a1595d5b35688c46bb7a2dcf154ac1c71}{Renderer}}.
...
Reimplemented from \mbox{\hyperlink{class_renderer_a01fff21b97aae0ab948b50f2476e639d}{Renderer}}.
...
\index{OpenGL@{OpenGL}!SetGlfwWindow@{SetGlfwWindow}}
\index{SetGlfwWindow@{SetGlfwWindow}!OpenGL@{OpenGL}}
\doxysubsubsection{\texorpdfstring{SetGlfwWindow()}{SetGlfwWindow()}}
{\footnotesize\ttfamily void Open\+GL\+::\+Set\+Glfw\+Window (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{class_glfw_window}{Glfw\+Window}} $\ast$}]{g }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily unsigned int Open\+GL\+::\+Texture\+From\+File (\begin{DoxyParamCaption}\item[{std\+::string}]{path }\end{DoxyParamCaption})}
...
\item 
ICT397-\/\+Project-\/\+Engine/\mbox{\hyperlink{_open_g_l_8h}{Open\+GL.\+h}}\item 
ICT397-\/\+Project-\/\+Engine/\mbox{\hyperlink{_open_g_l_8cpp}{Open\+GL.\+cpp}}\end{DoxyCompactItemize}
