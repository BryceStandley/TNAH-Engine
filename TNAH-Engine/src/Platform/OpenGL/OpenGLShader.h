...
namespace tnah {
	...
	private:
		...
		/**
		 * @fn	std::unordered_map<GLenum, std::pair<std::string, std::string>> OpenGLShader::PreProcess(const std::string& source, const std::string& shaderFilePath);
		 *
		 ...
		 *
		 * @returns	A std::unordered_map&lt;GLenum,std::pair&lt;std::string,std::string&gt;&gt;
		 */
