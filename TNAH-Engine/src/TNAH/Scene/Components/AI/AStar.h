...
{{ComponentCategory::Objects}}
    ...
    public:
         ...
         *
         * @fn IsValid
         * @breif Checks if the given point is valid
         * 
         * @param point
         * @return bool
         * @author chris
         ...
         *
         * @fn Update
         * @breif Updates the dynamic positions
         * 
         * @author chris
         */
        static void Update();
         ...
         *
         * @fn Reached
         * @breif Checks if the position is reached
         * 
         * @param point
         * @param destination
         * @return 
         ...
         *
         * @fn heuristic
         * @breif Gets the H value using square root
         * 
         * @param point
         * @param destination
         * @return 
         ...
         *
         * @fn Init
         * @breif Initilises the astar map
         * 
         ...
         *
         * @fn Algorithm
         * @breif DOes the algorithm calling make path
         * 
         * @param point
         * @param destination
         * @return 
         ...
         * @breif Generates a random position on the map
         * 
         ...
         *
         * @fn GetUsedPoints
         * @breif Gets the map points taht are obstacles
         * 
         * @return 
         * @author chris
         */
         ...
         *
         * @fn AddUsedPosition
         * @breif Adds the given position to the used map, and adds it to the dynamic one if dynamic
         * 
         * @param position
         * @param dynamic
         * @author chris
         ...
         *
         * @fn GetStartingPos
         * @breif Gets the starting position
         * 
         * @return 
         * @author chris
         */
    ...
    private:
         ...
         *
         * @fn makePath
         * @breif Creates the path used in the algorithm
         *
         * @param map
         * @param destination
         * @return
