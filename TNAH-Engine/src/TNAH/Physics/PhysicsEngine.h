...
namespace tnah::Physics
{
    ...
    public:
        ...
        static void ChangeE(float e) { E = glm::clamp(e, 0.0f, 1.0f); }
    private:
        static void EnableLogging();

        static bool IsColliderRenderingEnabled();

        static std::pair<std::pair<Ref<VertexArray>, Ref<VertexBuffer>>, std::pair<Ref<VertexArray>, Ref<VertexBuffer>>>
        ...
        static void UpdateRigidBody(RigidBodyComponent& rb, TransformComponent& transform);
    private:
