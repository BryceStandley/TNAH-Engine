...
namespace tnah::Physics {
		...
		public:
			/**
			* @enum tnah::Physics::Collider::Type
			*
			* @breif Different type flag enum.
			*
			* @author Bryce Standley
			* @date 6/11/2021
			*
			...
			*/
			...
			/**
			* @fn tnah::Physics::Collider Collider(rp3d::CollisionShape* collider);
			*
			* @breif Constructor
			*
			* @author Bryce Standley
			...
			*
			* @breif Sets the orientation value
			*
			* @author Bryce Standley
			* @date 6/11/2021
			*
