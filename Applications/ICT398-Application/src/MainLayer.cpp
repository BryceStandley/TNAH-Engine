...
#include <TNAH-App.h>
#include "characters/Dog/Dog.h"
#include "characters/Rubbish/Bin.h"
#include "characters/Student/Student.h"
	...
	:Layer("Main Layer")
{
	...
	// Camera Init
	{
		...
		rb.Body->SetLinearDampening(0.999f);
...
#pragma region SceneCreation
	...
	glm::vec3 binSize(1, 1, 1), binScale(0.3, 0.3, 0.3), binRotation(0, 0, 0);
	{
		...
		go.AddComponent<tnah::CharacterComponent>(tnah::CharacterNames::Rubbish, new Bin());
	}
	...
	
	{
		...
		tt.Scale = glm::vec3(0.015f);
		auto& rb = go.AddComponent<tnah::RigidBodyComponent>(go);
		
		go.AddComponent<tnah::AIComponent>();
		go.AddComponent<tnah::CharacterComponent>(tnah::CharacterNames::DogAi, new Dog());
	}

	{
		...
		go.AddComponent<tnah::AIComponent>();
		go.AddComponent<tnah::CharacterComponent>(tnah::CharacterNames::StudentAi, new Student());
	}
